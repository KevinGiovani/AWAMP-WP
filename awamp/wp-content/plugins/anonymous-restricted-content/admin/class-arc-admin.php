  ...
  */
	...
	*/
    public function plugin_options_redirect_field_cb($args)
    {
        ...
        ?>
            <input value="<?php echo $options[$args['label_for']]?>" type="url" class="regular-text code" name="arc_options[<?php echo esc_attr( $args['label_for'] ); ?>]" id="<?php echo esc_attr( $args['label_for'] ); ?>" value="">
        <?php
    }
		...
		*/
	    public function plugin_options_login_screen_message($args)
	    {
	        ...
	        ?>
	            <input value="<?php echo $options[$args['label_for']]?>" type="text" class="regular-text code" name="arc_options[<?php echo esc_attr( $args['label_for'] ); ?>]" id="<?php echo esc_attr( $args['label_for'] ); ?>" value="">
	        <?php
	    }
	        ...
	        ?>
						<label for="<?php echo esc_attr( $args['label_for'] ); ?>-off">
							<input type="radio" value="off" name="arc_options[<?php echo esc_attr( $args['label_for'] ); ?>]"
								<?php if ( $options[$args['label_for']] == 'off' || !isset($options[$args['label_for']]) ) echo "checked"; ?>
						...
						<label for="<?php echo esc_attr( $args['label_for'] ); ?>-off">
							<input type="radio" value="on" name="arc_options[<?php echo esc_attr( $args['label_for'] ); ?>]"
								<?php if ( $options[$args['label_for']] == 'on' ) echo "checked"; ?>
    ...
    public function plugin_options_cb( $args )
    {
		...
		*/
	    public function plugin_login_screen_cb( $args )
	    {
	        ...
	        <p><?php _e( 'Defaul message: "This content was restricted from anonymous access. Please, login first:"', 'anonymous-restricted-content' ); ?></p>
	        <?php
	    }
	...
	* @since    1.2.0
	*/
    public function register_gutenber_meta(){
