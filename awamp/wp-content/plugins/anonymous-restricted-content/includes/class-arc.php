...
class ARC {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action('init', $plugin_admin, 'register_gutenber_meta');
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter('widget_comments_args', $plugin_public, 'hide_rectricted_posts_in_query');
		$this->loader->add_filter('widget_posts_args', $plugin_public, 'hide_rectricted_posts_in_query');
		$this->loader->add_filter('wp_list_pages_excludes', $plugin_public, 'hide_rectricted_pages_in_list'); //hides in default primary menu
