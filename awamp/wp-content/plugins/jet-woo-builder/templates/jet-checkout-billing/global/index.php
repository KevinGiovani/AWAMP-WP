...
$form_label = esc_html__( $settings['checkout_billing_form_label_title_text'], 'jet-woo-builder' );
			...
			<?php if ( ! $checkout->is_registration_required() ) : ?>
				<p class="form-row form-row-wide create-account">
					<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
						...
						<span><?php echo ! empty( $form_label ) ? $form_label : esc_html__( 'Create an account?', 'woocommerce' ); ?></span>
					</label>
				</p>
			<?php endif; ?>
