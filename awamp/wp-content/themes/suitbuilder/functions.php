...
function suitbuilder_scripts() {
	...
	wp_enqueue_style( 'suitbuilder-block-styles', get_template_directory_uri() . '/assets/src/css/blocks.css' );
}
 ...
 */
function suitbuilder_editor_assets(){
	wp_enqueue_style( 'suitbuilder-block-editor-styles', get_template_directory_uri() . '/assets/src/css/block-editor-styles.css' );
}
add_action( 'enqueue_block_editor_assets', 'suitbuilder_editor_assets' );
...
require trailingslashit(get_template_directory() ).'/inc/class-excerpt.php';
/**
